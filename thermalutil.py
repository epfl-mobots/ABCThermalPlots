...
class ThermalFrame:
    ...
    def plot_thermal_field(self, ax, cmap=None, show_cb:bool=False, show_sensors:bool=False, show_max_temp:bool=False, contours=None, annotate_contours:bool=False, v_min=None, v_max=None, viewed_from:str = 'front'):
